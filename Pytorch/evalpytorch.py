...
model.load_state_dict(torch.load(
    "/media/carlos/FILES/INVESTIGACIÓN/Proyectos/Boundaries Detection/Trained models/MLS_4SSLM/saved_model_" + epochs + "epochs.bin",
...
for i in range(len(mels_trainloader)):
    ...
    P_ant, R_ant, F_ant, *_ = mir_eval.segment.detection(reference, pred_positions, window=window, beta=beta,
                                                         trim=False)
    P.append(P_ant)
    R.append(R_ant)
    F.append(F_ant)
